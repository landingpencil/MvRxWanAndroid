package com.pencil.mvrxwanandroid.http.cookies
...
import com.pencil.mvrxwanandroid.core.MvRxWanAndroidApplication.Companion.context
...
class PersistentCookieStore {
    ...
    init {
        cookiePrefs =  MvRxWanAndroidApplication.context.getSharedPreferences(COOKIE_PREFS, Context.MODE_PRIVATE)
